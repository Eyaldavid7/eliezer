...
def sample_translation_under_folder():
    ...
    endpoint = 'https://try.cognitiveservices.azure.com/'
    key = '608602fbcf3245eaa0c0924f012638c4'
    source_container_url = 'https://eyalselfgptstorage.blob.core.windows.net/booktranslate?sp=rwl&st=2023-04-27T19:58:37Z&se=2023-04-28T03:58:37Z&sv=2021-12-02&sr=c&sig=nABV%2Bsn0uF6FwNxKbxxqyOZb6jH6fgNpsnfYy1BSekc%3D'
    target_container_url = 'https://eyalselfgptstorage.blob.core.windows.net/booktranslateresult?sp=rwl&st=2023-04-27T20:03:03Z&se=2023-04-28T04:03:03Z&sv=2021-12-02&sr=c&sig=olA2eql7RHQSB26ptEUtYkQmxdjS8pgeKMcpL4Ij1N4%3D'
    client = DocumentTranslationClient(endpoint, AzureKeyCredential(key))

    poller = client.begin_translation(source_container_url, target_container_url, "en")
